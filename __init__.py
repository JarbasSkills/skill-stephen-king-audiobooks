...
class StephenKingAudioBooksSkill(OVOSCommonPlaybackSkill):
    def __init__(self):
        super(StephenKingAudioBooksSkill, self).__init__("StephenKingAudioBooks")
    ...
    def search_stephenking_audiobooks(self, phrase, media_type):
        ...
        if self.voc_match(phrase, "stephenking"):
            # explicitly requested stephenking
            base_score += 60
...
def create_skill():
    return StephenKingAudioBooksSkill()
